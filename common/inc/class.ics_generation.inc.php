...
class iCalGenerator
{
  ...
  /**
    ...
    const VERSION = "PRODID:-//David Horstman//Central Calendar Creator 1.0//EN";
    const EOL = "\r\n";
    private $header = "BEGIN:VCALENDAR".self::EOL
    .self::VERSION.self::EOL
  ...
  private  $class_schedule = array();
   ...
   public function getClassScheduleByDay($extID,$class_day){
    ...
    public function generateCalendar($extID){
        ...
        //$testarray = print_r($this->bell_schedules, true);
